...
--
-- Počítač: localhost
-- Vygenerováno: Středa 02. prosince 2015, 22:55
-- Verze MySQL: 5.0.51
-- Verze PHP: 5.2.5
...
(4, 'Pavel Röszler', 'pkiller', 'pavel.resler@zabijak.gmail.com', 'AndkD7DKJBAV6', 'Můj kámoš z bytu.', '88', 2, '', '112');
...
(6, 'Nové jméno produktu', 'Nový popisek produktu.', 666, 'false', 'Nová URL projektu', 88, 3, 1, 3);
...
(3, 'Huhu<strong>Kategorie</strong>', 'Slabá kategorie... i když má silný tagy'),
(10, '                $editRecord = false;                 $errorMessage .= "Jméno produktu nesmí být prázdné! <br>";u y', 'Tadadada to je jméno co?'),
(28, 'Hlavní kategorie', 'Demo pro Annu.'),
(29, 'Hlavní kategorie #2', 'Toto je fakt hlavní kategorie. Akorát je druhá no.'),
(30, '                $editRecord = false;                 $errorMessage .= "Jméno produktu nesmí být prázdné! <br>";', 'upraveno...'),
(31, ''' OR 1=1;', 'padadadada');
...
(3, 'Editovaná podkategorie <strong>s netučným</strong> jménem', 'This <u>is</u> popisek....', 3),
