...
--
-- Počítač: localhost
-- Vygenerováno: Neděle 06. prosince 2015, 13:40
-- Verze MySQL: 5.0.51
-- Verze PHP: 5.2.5
...
(2, 'Anna Popková', 'popanda', 'popkova.ann@gmail.com', 'AnH49rfN/5aHU', 'Horní Štěpánov\r\nZa Rohem', '945107/5555', 1, 'true', '(+420) 732378478'),
(4, 'Pavel Röszler', 'pkiller2', 'pavel.resler@zabijak.gmail.com', 'AndkD7DKJBAV6', 'Můj kámoš z bytu.', '88', 1, 'true', '112'),
(5, 'Matěj Dušek', 'mates', 'mates@dusek.com', 'AnHJmMc2CJWw.', 'Na Blahově 445/4\r\nVysoké Mýto 4\r\n566 01', '12345789', 1, 'true', '721852506');
...
(4, 'Produkt č. 2 - bez initial stacku', 'Ahojky', 12, 'true', 'http://lorempixel.com/400/200/', 2, 13, 1, 20, '0000-00-00 00:00:00'),
...
(8, 'Nějaká houska', 'Toto je fakticky dobrý produkt!', 2115, 'true', 'https://photos-6.dropbox.com/t/2/AAAs_5jSd_2zGOSKO_kZDJMHl6YRdJ2ynwAHoCA0x8W1rA/12/9427999/jpeg/32x32/1/_/1/2/food-q-c-150-150-2.jpg/ELq6gwcY1-EBIAcoBw/YigVVcfgt27HHYQ-p8_SXhnijgmnJmaLAeeaL2UmFm4?size=1024x768&size_mode=3', 48, 17, 2, 5, '2015-12-05 14:20:27'),
(9, 'Celozrné housky', 'Od nás pro Vás!', 890, 'true', 'https://photos-2.dropbox.com/t/2/AAAZYJBVaGeh5tcrCbshOX-QP1YxON4PpFhO472POa0o3Q/12/9427999/jpeg/32x32/1/_/1/2/food-q-c-150-150-7.jpg/ELq6gwcY1-EBIAcoBw/VMOS5W_bZgfN8Zynt_G9dflCTumjXjIVn38GqFWBoWw?size=1024x768&size_mode=3', 12, 6, 2, 3, '2015-12-05 14:21:05');
